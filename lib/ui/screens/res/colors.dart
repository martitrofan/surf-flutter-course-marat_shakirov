...
const appBarTitleColor = Colors.black87;

const sightCardTypeColor = Colors.white;
const sightCardDetailsColor = Color(0xff7C7E92);
const sightCardTitleColor = Color(0xff3B3E5B);

const bottomBackgroundColor = Color(0xffF5F5F5);
const visitTabBarBackgroundColor = Color(0xffF5F5F5);
...
const appBarActiveColor = Color(0xff3B3E5B);
